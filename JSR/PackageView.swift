...
struct PackageView: View {
    ...
    struct WebView: UIViewRepresentable {
        ...
        func makeUIView(context: Context) -> WKWebView {
            ...
            let html = "<html><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"><link rel=\"stylesheet\" href=\"https://jsr.io/styles.css\"><style>\(css)</style><div class=\"ddoc\" id=\"docMain\">\(text)</div></html>"
    ...
    func getDocs() async {
        do {
            let response =  try await client.client.getPackageVersionDocs(path: .init(scope: package.scope, package: package.name, version: version))
            switch response {
        ...
        NavigationStack {
            GeometryReader { reader in
                ScrollView {
                    ...
                    if let d = docs {
                        let binding = Binding { d } set: { docs = $0 }
...
#Preview {
    PackageView(client: ClientObj(client: Client(
